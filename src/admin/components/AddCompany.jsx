...
function AddCompanyForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrorMessage(error.response?.data?.message || 'Failed to add company');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className='flex min-h-screen justify-center items-center bg-gray-100 dark:bg-gray-900 p-4 sm:p-8'>
      <div className='max-w-2xl mx-auto w-full'>
        ...
        <div className='w-full bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700'>
          <h2 className='text-2xl font-bold text-gray-800 dark:text-white mb-2'>Company Details</h2>
          <p className='text-gray-600 dark:text-gray-400 mb-8'>Enter the name of the new company you wish to add.</p>
